...
// creating varible 
var current_users = ["Usman Ghazi", "Shayan Ali", "Noor Chasham", "JHON ALYA", "khalid hussain", "ZAFAR ZADRAN", "abdul razak"];
var new_users = ["Maqsood Ahmed", "Hassan Karim", "zafar zadran", "jhon alya", "USMAN GHAZI", "Rizwan Mubeen", "Abdul Razak"];
// coping both varibale to lower case for comparison is case insensitive 
var lowercurrent_user = current_users.map(function (User) { return User.toLowerCase(); });
var lownew_users = new_users.map(function (UserN) { return UserN.toLowerCase(); });
var A = 0;
var B = 0;
